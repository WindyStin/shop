...
<nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="index.jsp">后台</a>
        </div>
        <div>
            <ul class="nav navbar-nav">
                ...
                <li ><a href="/admin/record_list">客户购买记录</a></li>
                <li ><a href="/admin/sell_count">销量统计</a></li>
<%--                <li ><a href="/admin/post_email">邮件发送</a></li>--%>
